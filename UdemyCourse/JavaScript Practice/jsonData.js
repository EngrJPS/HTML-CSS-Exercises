...
const stringSkills = JSON.stringify(skills, undefined, 2);

console.log(stringSkills);

// Stringify the age variable
const stringAge = JSON.stringify(age, undefined, 4);
...
const studentSkills = JSON.stringify(student, [`skills`], 4);
...
const objSkills = JSON.parse(txt, (key, value) => {
